...
public class HelpRequestsControllerTests extends ControllerTestCase {
  ...
  public void an_admin_user_can_post_a_new_help_request() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/help_requests/post?requesterEmail=hao_ding@ucsb.edu&teamId=13&tableOrBreakoutRoom=13&requestTime=2022-01-03T00:00:00&explanation=You need to blah blah blah.&solved=false")
                    .with(csrf()))
